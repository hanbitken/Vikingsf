...
const PackageDonation = () => {
  ...
  const formFields = [
    ...
    { label: 'Title', name: 'title', type: 'text', required: true, placeholder: 'Enter package title' },
    { label: 'Description', name: 'description', type: 'textarea', required: false, placeholder: 'Enter package description' },
    { label: 'Pricing', name: 'pricing', type: 'text', required: true, placeholder: 'Enter pricing (e.g., 10000 IDR)' },
  ];
  ...
  return (
    <div className="container mx-auto p-4 max-w-6xl">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-gray-800">Package Donation</h2>
        <button
        ...
        <table className="min-w-full leading-normal">
          <thead>
            <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
              ...
              <th className="py-3 px-6 text-left">Timestamps</th>
              <th className="py-3 px-6 text-center">Action</th>
            </tr>
          </thead>
          <tbody className="text-gray-700 text-sm">
            {packageDonations.map((item, index) => (
              <tr
                key={item.id}
              ...
              >
                ...
                <td className="py-3 px-6 text-left">{dayjs(item.timestamps).format('DD/MM/YYYY HH:mm:ss')}</td>
          ...
          >
            <div className="flex justify-between items-center pb-3 border-b border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900">
                {currentItem ? 'Edit Package Donation' : 'Tambah Package Donation'}
              </h3>
              <button
