...
export default function QuestInfo() {
  ...
  const quests = [
    {
      title: "Daily Quest [Afterwar (Morning, Afternoon, Night)]",
      content: "Details for Afterwar quests...",
    },
    { title: "Daily Quest [Sunday]", content: "Details for Sunday's quest..." },
    {
      title: "Daily Quest [Saturday]",
      content: "Details for Saturday's quest...",
    },
    { title: "Daily Quest [Friday]", content: "Details for Friday's quest..." },
    {
      title: "Daily Quest [Thursday]",
      content: "Details for Thursday's quest...",
    },
    {
      title: "Daily Quest [Wednesday]",
      content: "Details for Wednesday's quest...",
    },
    {
      title: "Daily Quest [Tuesday]",
      content: "Details for Tuesday's quest...",
    },
