...
export default function Donation() {
    ...
    const servers = [
        { title: "Feature Information", content: "Details for Feature Information..." },
        { title: "General Information", content: "Details for General Information..." },
        { title: "NPC List Information", content: "Details for NPC List Information..." },
        { title: "Drop List Information", content: "Details for Drop List Information..." },
    ];
                            ...
                            <div key={index} className='w-full'>
                                ...
                                >
                                    <div className='flex items-center font-semibold'>
                                        <FaChevronRight size={14} className="mr-3" /> {/* Ganti '》' dengan ikon */}
